...
okapi::Motor LiftLeft(5, false, okapi::AbstractMotor::gearset::red);
okapi::Motor LiftRight(6, true, okapi::AbstractMotor::gearset::red);
okapi::MotorGroup Lift({LiftLeft, LiftRight});

okapi::Motor FlagTop(7);
okapi::Motor FlagBottom(8);
okapi::MotorGroup Flag({FlagTop, FlagBottom});
